...
//		return new SuccessResponse<>(SuccessCode.CURRENCY_SAVE, currency, HttpStatus.CREATED, currency.getCurrency());
//	}
//
//	/**
//	 * Update a currency,
...
//		return new SuccessResponse<>(SuccessCode.CURRENCY_UPDATE, currency, HttpStatus.OK, currency.getCurrency());
//	}
//
//	/**
...
//		return new SuccessResponse<>(SuccessCode.GET_CURRENCY_SUCCESS, currency, HttpStatus.OK, currency.getCurrency());
//	}
//
//	/**
...
//		return new SuccessResponse<List<CurrencyDTO>>(SuccessCode.GET_CURRENCIES_SUCCESS, currencies, 0, HttpStatus.OK);
//	}
//
//	/**
...
//	 *
//	 * @param Currency - department detail
//	 * @return Department Entity
//	 */
...
//		return new SuccessResponse<List<DepartmentDTO>>(SuccessCode.GET_DEPARTMENTS_SUCCESS, departments, 0,
//				HttpStatus.OK);
//	}
//
//	/**
...
//		return new SuccessResponse<List<FiscalCalendarDTO>>(SuccessCode.GET_FISCAL_DEPTS_SUCCESS, fiscalCalendars, 0,
//				HttpStatus.OK);
//	}
	...
	public SuccessResponse<GroupCompany> addGroupCompany(@Valid @RequestBody GroupCompanyDTO groupCompanyDTO) {
		...
		return new SuccessResponse<>(SuccessCode.GC_SAVE, groupCompany, HttpStatus.CREATED, groupCompany.getGcName());
	}
	...
	public SuccessResponse<GroupCompany> updateGroupCompany(@Valid @RequestBody GroupCompany groupCompany) {
		...
		return new SuccessResponse<>(SuccessCode.GC_UPDATE, groupCompany, HttpStatus.OK, groupCompany.getGcName());
	}
	...
	public SuccessResponse<GroupCompany> getGroupCompany(@PathVariable(value = "id") long gcId) {
		...
		return new SuccessResponse<>(SuccessCode.GET_GC_SUCCESS, groupCompany, HttpStatus.OK, groupCompany.getGcName());
	}
	...
	public SuccessResponse<List<GroupCompanyDTO>> getAllGroupCompany() {
		...
		return new SuccessResponse<List<GroupCompanyDTO>>(SuccessCode.GET_GC_LIST_SUCCESS, GroupCompanys.get(0), HttpStatus.OK);
	}
...
//		return new SuccessResponse<>(SuccessCode.COMPANY_SAVE, company, HttpStatus.CREATED, company.getName());
//	}
//
//	/**
...
//		return new SuccessResponse<>(SuccessCode.COMPANY_UPDATE, company, HttpStatus.OK, company.getName());
//	}
//
//	/**
...
//		return new SuccessResponse<>(SuccessCode.GET_COMPANY_SUCCESS, company, HttpStatus.OK, company.getName());
//	}
//
//	/**
...
//		return new SuccessResponse<List<CompanyDTO>>(SuccessCode.GET_COMPANY_LIST_SUCCESS, GroupCompanys, 0,
//				HttpStatus.OK);
//	}
//
//
...
//		return new SuccessResponse<>(SuccessCode.BU_SAVE, businessUnit, HttpStatus.CREATED, businessUnit.getName());
//	}
//
//	/**
...
//		return new SuccessResponse<>(SuccessCode.BU_UPDATE, businessUnit, HttpStatus.OK, businessUnit.getName());
//	}
//
//	/**
...
//		return new SuccessResponse<>(SuccessCode.GET_BU_SUCCESS, businessUnit, HttpStatus.OK, businessUnit.getName());
//	}
//
//	/**
...
//		return new SuccessResponse<List<BusinessUnitDTO>>(SuccessCode.GET_BU_LIST_SUCCESS, businessUnits, 0,
//				HttpStatus.OK);
//	}
}